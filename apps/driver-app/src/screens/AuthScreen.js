...
export default function AuthScreen() {
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={s.container}>
      <View style={s.badge}><Text style={s.badgeText}>WHEELIND · DRIVER</Text></View>
...
const s = StyleSheet.create({
  ...
  badge: { alignSelf: "flex-start", borderWidth: 1, borderColor: theme.amber, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5, marginBottom: 24 },
  badgeText: { color: theme.amber, fontWeight: "800", letterSpacing: 2, fontSize: 12 },
